  ...
  const footer = (
    <div className={`bg-primary text-primary-foreground py-12 ${footerClassName}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="mt-4 opacity-70">
              Premium pet wellness & nutrition
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-primary-foreground/20 text-center opacity-70">
          <p>&copy; 2025 Pet Wellness Store. All rights reserved.</p>
        </div>
      </div>
    </div>
  )
